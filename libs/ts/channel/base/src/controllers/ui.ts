...
export const setFrameSize = (payload?: { height?: number; width?: number }, params?: ServerParams) => {
	if (!params?.origin) {
...
export class UIController implements Controller {
	...
	public changeFrameSizeDynamically = (selector = 'body', {exclude}: ChangeFrameSizeDynamicallyProps) => {
