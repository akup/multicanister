...
export class ChannelHost<Client extends string = ChannelClientMethods, Server extends string = string> extends Channel<Client | ChannelClientMethods, Server | ChannelHostMethods> {
