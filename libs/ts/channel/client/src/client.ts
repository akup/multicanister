...
export class ChannelConsumer<C extends string = string, S extends string = string> extends Channel<
  C | ChannelClientMethods,
  S
> {
  ...
  constructor(opts: ChannelConsumerOpts) {
    ...
    this.delegation = new DelegationController(this, {
      agent: opts.agent,
