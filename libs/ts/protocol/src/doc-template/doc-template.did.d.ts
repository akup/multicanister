...
export interface GetDocumentRequest { 'id' : DocumentId }
export interface GetDocumentResponse { 'document' : Document }
export interface GetDocumentsResponse { 'documents' : Array<Document> }
export interface IssueResponse { 'document' : Document }
