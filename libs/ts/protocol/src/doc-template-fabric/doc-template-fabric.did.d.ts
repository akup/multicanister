...
export interface Instance { 'name' : string, 'canister_id' : Principal }
...
export interface _SERVICE {
  ...
  'get_instance_wasm' : () => Promise<Array<number>>,
  'get_spawned_instances' : () => Promise<Array<Instance>>,
  'http_request' : (arg_0: HttpRequest) => Promise<HttpResponse>,
  'http_request_streaming_callback' : (
      arg_0: StreamingCallbackToken,
    ) => Promise<[] | [StreamingCallbackHttpResponse]>,
  'init' : (arg_0: Principal) => Promise<undefined>,
  'list' : (arg_0: {}) => Promise<
      Array<
        {
          'key' : Key,
  ...
  'spawn' : (arg_0: string, arg_1: string) => Promise<Principal>,
  'store' : (
      arg_0: {
        'key' : Key,
        'content' : Array<number>,
